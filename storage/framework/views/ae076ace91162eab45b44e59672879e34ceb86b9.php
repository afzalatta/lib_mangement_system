							...
							<div class="card-body p-0">
								<div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
									<div class="col-xl-12 col-xxl-10">
										<form class="form" action="<?php echo e(url('admin/book/add')); ?>" method="post" enctype="multipart/form-data">
										<?php echo e(csrf_field()); ?>

											<div class="row justify-content-center">
												<div class="col-xl-9">
													<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
														<h5 class="text-dark font-weight-bold mb-10">Add Book</h5>
														...
														<div class="form-group row">
																...
																<div class="col-lg-9 col-xl-9">
																	...
																	<select name="category" class="form-control form-control-solid form-control-lg" required> 
                                                                        <option selected="true" disabled="disabled" >--Please Select--  </option>
                                                                            ...
                                                                            <option value="<?php echo e($category->id); ?>"  <?php if($category->id==old('category')): ?> selected <?php endif; ?>><?php echo e($category->name); ?> </option>
																...
																<div class="col-lg-9 col-xl-9">
																	...
																	<select name="publisher" class="form-control form-control-solid form-control-lg" required> 
                                                                        <option selected="true" disabled="disabled" >--Please Select--  </option>
                                                                            ...
                                                                            <option value="<?php echo e($publisher->id); ?>"  <?php if($publisher->id==old('publisher')): ?> selected <?php endif; ?>><?php echo e($publisher->name); ?> </option>
                                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                        </select>
																...
																<div class="col-lg-9 col-xl-9">
																	...
																	<select name="author" class="form-control form-control-solid form-control-lg" required> 
                                                                        <option selected="true" disabled="disabled" >--Please Select--  </option>
                                                                            ...
                                                                            <option value="<?php echo e($author->id); ?>"  <?php if($author->id==old('author')): ?> selected <?php endif; ?>><?php echo e($author->name); ?> </option>
                                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                        </select>
															...
															<div class="form-group row">
																...
																<div class="col-lg-9 col-xl-9">
																	...
																	<input type="number" step="any" class="form-control form-control-solid form-control-lg" name="price" placeholder=" Price " value="<?php echo e(old('price')); ?>">
															...
															<div class="form-group row">
																...
																<div class="col-lg-9 col-xl-9">
																	...
																	<input type="number" step="any"  class="form-control form-control-solid form-control-lg " name="qty" placeholder=" Quantity " value="<?php echo e(old('qty')); ?>">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\installed Xampp\htdocs\my projects\Library ManagmentV3\Library Managment\resources\views/admin/book/add_book.blade.php ENDPATH**/ ?>
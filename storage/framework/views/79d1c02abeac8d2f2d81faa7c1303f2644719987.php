							...
							<div class="card-body p-0">
								<div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
									<div class="col-xl-12 col-xxl-10">
										<form class="form" action="<?php echo e(url('admin/publisher/edit/'.$publisher->id)); ?>" method="post" enctype="multipart/form-data">
														...
														<h5 class="text-dark font-weight-bold mb-10">Edit Publisher</h5>
                                                            ...
                                                            <div class="form-group row">
																...
																<div class="col-lg-9 col-xl-9">
																	...
																	<input type="text"   class="form-control form-control-solid form-control-lg count-chars" id = "CharCounter" data-chars-max="20" data-msg-color="danger" maxlength="20"  name="name" placeholder=" Name " value="<?php echo e($publisher->name); ?>">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\installed Xampp\htdocs\my projects\Library ManagmentV3\Library Managment\resources\views/admin/publisher/edit_publisher.blade.php ENDPATH**/ ?>
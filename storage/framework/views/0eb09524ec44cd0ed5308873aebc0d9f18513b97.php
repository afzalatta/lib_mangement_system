						...
						<div class="header-top">
							<div class="container">
								<div class="d-none d-lg-flex align-items-center mr-3">
									<a href="<?php echo e(url('admin/students')); ?>" class="mr-20">
										<img alt="Logo" src="<?php echo e(asset('/logo.png')); ?>" class="max-h-35px" />
									</a>
									<ul class="header-tabs nav align-self-end font-size-lg" role="tablist">
										<li class="nav-item">
											<a href="<?php echo e(url('admin/students')); ?>" class="nav-link py-4 px-6 <?=setSectionActive($homeItems)?>" >Dashboard</a>
										</li>
										<li class="nav-item">
...
<?php /**PATH D:\installed Xampp\htdocs\my_projects\Library ManagmentV3\Library Managment\resources\views/admin/layout/app.blade.php ENDPATH**/ ?>
				...
				<div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image:url(<?php echo e(url('/admin_assets/media/bg/bg-3.jpg')); ?>)">
					<div class="login-form text-center p-7 position-relative overflow-hidden">
						...
						<div class="login-signin">
							...
							<?php endif; ?>
							<form class="form" action="<?php echo e(url('/admin/login')); ?>" method="post">
							<?php echo csrf_field(); ?>
								...
								<div class="form-group d-flex flex-wrap justify-content-between align-items-center">
									...
									<a href="<?php echo e(url('admin/password/reset')); ?>" id="kt_login_forgot" class="text-muted text-hover-primary">Forget Password ?</a>
								</div>
								<button  type="submit" class="btn blue-color-bg font-weight-bold px-9 py-4 my-3 mx-4">Sign In</button>
							</form>
...
<?php echo $__env->make('AdminAuth.layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\installed Xampp\htdocs\my projects\Library ManagmentV3\Library Managment\resources\views/AdminAuth/login.blade.php ENDPATH**/ ?>
							...
							<div class="card-body p-0">
								<div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
									<div class="col-xl-12 col-xxl-10">
										<form class="form" action="{{url('admin/student/add')}}" method="post" enctype="multipart/form-data">
										{{csrf_field()}}
														...
														<h5 class="text-dark font-weight-bold mb-10">Add Student</h5>
                                                            ...
                                                            <div class="form-group row">
																...
																<div class="col-lg-9 col-xl-9">
																	...
																	<input type="text"   class="form-control form-control-solid form-control-lg count-chars" id = "CharCounter" data-chars-max="20" data-msg-color="danger" maxlength="20"  name="name" placeholder=" Name " value="{{ old('name') }}">
															...
															<div class="form-group row">
																...
																<div class="col-lg-9 col-xl-9">
																	<div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
																		<input type="email"   class="form-control form-control-solid form-control-lg count-email" id = "EmailCounter" data-email-max="50" data-msg-color="danger" maxlength="50" name="email" placeholder=" Email " value="{{ old('email') }}">
																		@if ($errors->has('email'))
																			<span class="help-block" style="color: red">
                                                            ...
                                                            <div class="form-group row">
																...
																<div class="col-lg-9 col-xl-9">
																	<div class="form-group{{ $errors->has('class') ? ' has-error' : '' }}">
																		<input type="text" class="form-control form-control-solid form-control-lg" name="class" placeholder="Class" value="{{ old('class') }}">
																		@if ($errors->has('class'))
																			<span class="help-block" style="color: red">
															...
															<div class="form-group row">
																...
																<div class="col-lg-9 col-xl-9">
																	<div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
																		<input type="text" class="form-control form-control-solid form-control-lg" name="phone" placeholder="Brand Phone" value="{{ old('phone') }}">
																		@if ($errors->has('phone'))
																			<span class="help-block" style="color: red">
															...
															<div class="form-group row">
																...
																<div class="col-lg-9 col-xl-9">
																	<div class="form-group{{ $errors->has('age') ? ' has-error' : '' }}">
																		<input type="number" class="form-control form-control-solid form-control-lg" name="age" placeholder="Age" value="{{ old('age') }}">
																		@if ($errors->has('age'))
																			<span class="help-block" style="color: red">
                                                            ...
                                                            <div class="form-group row">
																...
																<div class="col-lg-9 col-xl-9">
																	...
																	<textarea name="address" class="form-control form-control-solid form-control-lg" placeholder="Brand Address" >{{old('address')}}</textarea>

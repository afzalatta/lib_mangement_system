							...
							<div class="card-body p-0">
								<div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
									<div class="col-xl-12 col-xxl-10">
										<form class="form" action="{{url('admin/book/add')}}" method="post" enctype="multipart/form-data">
										{{csrf_field()}}
														...
														<div class="form-group row">
																...
																<div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
																	<div class="image-input image-input-outline" id="kt_user_add_avatar">
																		...
																		<img id="preview_img" src="{{asset('/uploads/no_image.png')}}" class="" width="200" height="200"/>
																...
																<div class="col-lg-9 col-xl-9">
																	...
																	<select name="publisher" class="form-control form-control-solid form-control-lg" required> 
                                                                        <option selected="true" disabled="disabled" >--Please Select--  </option>
                                                                            ...
                                                                            <option value="{{$publisher->id}}"  @if($publisher->id==old('publisher')) selected @endif>{{$publisher->name}} </option>
                                                                            @endforeach
                                                                        </select>
																...
																<div class="col-lg-9 col-xl-9">
																	...
																	<select name="author" class="form-control form-control-solid form-control-lg" required> 
                                                                        <option selected="true" disabled="disabled" >--Please Select--  </option>
                                                                            ...
                                                                            <option value="{{$author->id}}"  @if($author->id==old('author')) selected @endif>{{$author->name}} </option>
                                                                            @endforeach
                                                                        </select>
															...
															<div class="form-group row">
																...
																<div class="col-lg-9 col-xl-9">
																	...
																	<input type="number" step="any" class="form-control form-control-solid form-control-lg" name="price" placeholder=" Price " value="{{ old('price') }}">
															...
															<div class="form-group row">
																...
																<div class="col-lg-9 col-xl-9">
																	...
																	<input type="number" step="any"  class="form-control form-control-solid form-control-lg " name="qty" placeholder=" Quantity " value="{{ old('qty') }}">

														...
														<div class="form-group row">
															...
															<div class="form-group row">
																...
																<div class="col-lg-9 col-xl-9">
																	...
																	<input type="text"   class="form-control form-control-solid form-control-lg" name="price" placeholder=" Price " value="{{ $book->price }}">
															...
															<div class="form-group row">
																...
																<div class="col-lg-9 col-xl-9">
																	...
																	<input type="text"   class="form-control form-control-solid form-control-lg" name="qty" placeholder=" Quantity " value="{{ $book->quantity }}">

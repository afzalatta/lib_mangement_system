							...
							<div class="card-body p-0">
								<div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
									<div class="col-xl-12 col-xxl-10">
										<form class="form" action="{{url('admin/book/issue/add/'.$book_id)}}" method="post" enctype="multipart/form-data">
										{{csrf_field()}}
											<div class="row justify-content-center">
												<div class="col-xl-9">
													<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
														<h5 class="text-dark font-weight-bold mb-10">Issue Book</h5>
															...
															<div class="form-group row">
																...
																<div class="col-lg-9 col-xl-9">
																	...
																	<select name="student" class="form-control form-control-solid form-control-lg" required> 
															...
															<div class="form-group row">
																<label class="col-xl-3 col-lg-3 col-form-label"> Return Date </label>
																<div class="col-lg-9 col-xl-9">
																	<div class="form-group{{ $errors->has('return_date') ? ' has-error' : '' }}">
																	<input type="date"   class="form-control form-control-solid form-control-lg"   name="return_date" placeholder=" Return Date " value="{{ old('return_date') }}">

			...
			<div class="card card-custom">
				<div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <a href="{{url('admin/author/add')}}" class="btn blue-color-bg font-weight-bolder">
				...
				<div class="card-body">
					...
					<table id="example"  class="table" style="width:100%">
						...
						<tbody>
							...
							@foreach($all_authors as $single_store) 
							...
							<tr>
								...
								<td style="width:20%"> 
									<a href="{{url('/admin/author/edit/'.$single_store->id)}}" class="btn btn-sm btn-clean btn-icon tooltips" ><i class="fas fa-edit blue-color" title="Edit"></i> </a>
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-footer">
											...
											<a href="{{url('/admin/author/delete/'.$single_store->id)}}" class="btn btn-danger">Delete</a>
										</div>
									</div>
								</div>
							</div>

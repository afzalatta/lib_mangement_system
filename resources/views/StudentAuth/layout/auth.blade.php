...
<head>
		...
		<link href="{{asset('/admin_assets/css/pages/login/classic/login-45883.css?v=7.2.9')}}" rel="stylesheet" type="text/css" />
	...
	<script>var HOST_URL = "https://preview.keenthemes.com/metronic/theme/html/tools/preview";</script>
		...
		<script src="{{asset('/admin_assets/js/pages/custom/login/login-general5883.js?v=7.2.9')}}"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->

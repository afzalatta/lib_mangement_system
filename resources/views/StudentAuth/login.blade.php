							...
							@csrf
								...
								<div class="form-group d-flex flex-wrap justify-content-between align-items-center">
									<div class="checkbox-inline">
										<a href="{{url('/student/register')}}" class="text-muted text-hover-primary">
											<span></span>Don't have an account?
										</a>
									</div>
									<a href="{{url('student/password/reset')}}" id="kt_login_forgot" class="text-muted text-hover-primary">Forget Password ?</a>
								</div>

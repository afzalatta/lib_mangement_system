					...
					<div class="login-form text-center p-7 position-relative overflow-hidden">
						...
						<div class="login-signin">
							...
							<div class="mb-20">
								...
								<div class="text-muted font-weight-bold">Enter your details to create account:</div>
							</div>
							...
							@endif
							<form class="form" action="{{url('/student/register')}}" method="post">
							@csrf
                            <div class="form-group mb-5">
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
									<input class="form-control h-auto form-control-solid py-4 px-8" type="text" placeholder="Name" name="name" autocomplete="off" value="{{ old('name') }}"/>
									@if ($errors->has('name'))
								...
								<button  type="submit" class="btn blue-color-bg font-weight-bold px-9 py-4 my-3 mx-4">Sign Up</button>
							</form>
